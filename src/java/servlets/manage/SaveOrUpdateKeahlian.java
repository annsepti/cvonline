 ...
 * @author Nande
 */
@WebServlet(name = "SaveOrUpdateKeahlian", urlPatterns = {"/soukeahlian"})
public class SaveOrUpdateKeahlian extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Date date = new Date(request.getParameter("tglsertifikat"));
