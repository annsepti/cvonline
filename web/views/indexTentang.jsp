                    ...
                    <div class="container box_1620">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            <ul class="nav navbar-nav menu_nav justify-content-center">
                                ...
                                <li class="nav-item active"><a class="nav-link" href="indexTentang.jsp">Tentang</a></li> 
                                <li class="nav-item"><a class="nav-link" href="indexLowongan.jsp">Lowongan</a>
                            </ul>
                        </div> 
                    </div>
                </nav>
				...
				<div class="container">
					<div class="banner_content">
						...
						<div class="page_link">
							...
							<a href="indexTentang.jsp">Tentang</a>
						</div>
					</div>
				</div>
            </div>
        ...
        <section class="mission_area">
			<div class="row m0">
				<div class="col-lg-6 p0">
					<div class="left_img"><img src="../home/img/slider/slider-1.jpg" width="1000px" alt=""></div>
				</div>
				<div class="col-lg-6 p0">
