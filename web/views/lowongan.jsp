                                ...
                                <div class="card-body">
                                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a class="menu-icon fa fa-edit" href="./editLowongan?id=<%= lowongan.getIdLowongan()%>"></a> |
                                                    <a class="menu-icon fa fa-trash" href="./deleteLowongan?id=<%= lowongan.getIdLowongan()%>"></a></td>
